...
13. Open [Billing](https://console.cloud.google.com/billing/). Add new billing account. This is to track AI cost, and to ensure AI calls (through Vertex AI, gemini-3.6-flash) could run. If you got 150 $ Google Cloud Credit, follow the simple instruction in Devpost email to redeem the code. Then go to Credits in the left tab. You will see the credits is added. Then all AI cost will be automatically charged to that credit.
