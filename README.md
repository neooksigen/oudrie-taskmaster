...
6. Oudrie will execute task one-by-one from task 001, until task 007. After task 007 finished, the automation stops. In tab "Tasks", column "Vertex AI Log" is filled by Oudrie to explain the handoffs, column "Update Timestamp" is filled when the task is finished.
...
12. Oudrie will copy all approved tasks lists from tab "Tasks" into [tab "Archive Tasks"](https://docs.google.com/spreadsheets/d/1lmGAV-5JFeEzWy-nZ3o3SEZF49plo8bFPHUSbg_MnBc/edit?gid=1148560669#gid=1148560669). Plus adding Closing Timestamp to indicate when the task are officially closed. Then on tab "Tasks", Oudrie will clean up contents on column "Vertex AI Log", "Update Timestamp", and "Approved (Yes/No)".
